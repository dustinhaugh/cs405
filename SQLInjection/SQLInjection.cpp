...
#include <tuple>
#include <vector>
#include <stdlib.h>     // ADDED: Dustin Haugh CS 405
#include <string>       // ADDED: Dustin Haugh CS 405
#include "sqlite3.h"

using namespace std;    // ADDED: Dustin Haugh CS 405
...
bool run_query(sqlite3* db, const std::string& sql, std::vector< user_record >& records)
{
  ...
  //  something more generic
    ...
    // ADDED: Dustin Haugh CS 405 Below

    cout << "" << endl;
    cout << "" << endl;
    cout << "SQL Query Tested:" << endl;
    cout << sql << endl;
    cout << "" << endl;
    cout << "SQL Result/s:" << endl;

    // I am specifically looking for these strings within the query. This is a form of sanitization
    if (sql.find(" or ") != std::string::npos) {
        cout << "Found possible SQL injection, inquery denied." << endl;
        return false;
    }
    ...
    // ADDED: Dustin Haugh CS 405 Above
